package com.example.springsecurity.models.base;

import com.example.springsecurity.exception.BaseException;
import com.example.springsecurity.exception.types.NotFoundExceptionType;
import com.example.springsecurity.models.enums.response.ResponseMessages;
...
import static com.example.springsecurity.models.enums.response.ErrorResponseMessages.NOT_FOUND;
import static com.example.springsecurity.models.enums.response.SuccessResponseMessages.SUCCESS;
import static com.example.springsecurity.models.enums.response.SuccessResponseMessages.SUCCESS_REGISTER;
...
public class BaseResponse<T> {
    ...
    public static <T> BaseResponse<T> successRegister(T data) {
        return BaseResponse.<T>builder()
                .status(HttpStatus.CREATED)
                .data(data)
                .meta(Meta.of(SUCCESS_REGISTER))
                .build();
    }
